const plants = [
    {
      ...
      price: '39.99',
      like: true,
      img: require('../../assets/image/strawberry.png'),
      about:
  ...
  
    {
      ...
      price: '29.99',
      like: false,
      img: require('../../assets/image/Apple.png'),
      about:
    ...
    },
    {
      ...
      price: '25.99',
      like: false,
      img:  require('../../assets/image/orange.png'),
      about:
  ...
  
    {
      ...
      price: '25.99',
      like: true,
      img:  require('../../assets/image/mango.png'),
      about:
    ...
    },
    {
      ...
      price: '50.99',
      like: true,
      img:  require('../../assets/image/pineapple.png'),
      about:
        'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
    {
      ...
      price: '50.99',
      like: false,
      img:  require('../../assets/image/grapes.png'),
      about:
        'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
  ];
